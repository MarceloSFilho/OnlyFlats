...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference("Flat.count") do
      post flats_url, params: { flat: { address: @flat.address, avaliable: @flat.avaliable, photo: @flat.photo, price: @flat.price, title: @flat.title, user_id: @flat.user_id } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { address: @flat.address, avaliable: @flat.avaliable, photo: @flat.photo, price: @flat.price, title: @flat.title, user_id: @flat.user_id } }
